...
export default class RFB extends EventTargetMixin {
	...
	_clientHasExpectedSize() {
		...
		return (
			currentWidth == this._expectedClientWidth && currentHeight == this._expectedClientHeight
		);
	}
	...
	_negotiateProtocolVersion() {
		...
		const cversion =
			'00' + parseInt(this._rfbVersion, 10) + '.00' + ((this._rfbVersion * 10) % 10);
...
RFB.messages = {
	...
	extendedClipboardProvide(sock, formats, inData) {
		...
		data.set(
			RFB.messages._buildExtendedClipboardFlags([extendedClipboardActionProvide], formats)
		);
...
RFB.cursors = {
	...
	dot: {
		...
		rgbaPixels: new Uint8Array([
			255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 0, 0, 0, 0, 0, 0, 0,
