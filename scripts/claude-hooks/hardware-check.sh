...
# Only check commands that actually interact with hardware or hardware APIs.
# Skip git, npm, tsc, and other dev-tool commands that may reference hackrf in filenames/messages.
