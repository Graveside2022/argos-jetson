...
| 8         | Deferred cleanup bundle (PanelStatus + TooltipIcon + Popover + ToolsFlyout + EditorTabBar + SkeletonText + bits-ui drop + eslint config restructure) | `feature/spec-026-carbon-phase-8-deferred-{<sub>}`                 | ✅ Done 2026-05-05 · 8.1+8.3+8.4 (PR #97), 8.6 (2026-05-04), 8.7 (2026-05-04), 8.8 (2026-05-05) | `spec-026-phase-8-complete` | Medium-High | 5-9 days |
