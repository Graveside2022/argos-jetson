...
|                  2 | `src/lib/server/middleware/` (auth, CSRF, security-headers)  |             4 | **CRITICAL** — unauthorized access, request forgery                    | DONE     | ✅ done (PR #243) — 92.50% (28.69% baseline)                                                                                                                                                                                                                                                                 |
|                  3 | `src/lib/server/hardware/` (claim/release, resource-manager) |            18 | **CRITICAL** — race conditions, USB device contention, corrupted state | DONE     | ✅ done — cheap-audit substitute methodology (see `docs/mutation-baseline-2026-05-26-phase4.md`); full-hardware stryker ETA 3hr exceeded roadmap budget, pivoted to ESLint + senior review + reasoned hand-mutation + targeted test additions; +14 tests, 4 MED source bugs found (deferred to follow-up PR) |
