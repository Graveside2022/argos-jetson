...
/** Visibility mode — persisted to localStorage (ADR-0003: persistedState rune).
 ...
 */
export const visibilityMode = persistedState<VisibilityMode>('argos-visibility-mode-v2', 'all', {
	schema: VisibilityModeSchema
});

/** Set of manually promoted device MACs — visible in all modes. */
export const promotedDevices = persistedState<Set<string>>('argos-promoted-devices', new Set(), {
