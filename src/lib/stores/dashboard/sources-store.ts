...
const MOCK_SOURCES: SourceStatus[] = [
	{ id: 'hackrf', name: 'HackRF One', state: 'LIVE', since: '0:35', band: '24–1700 MHz', rate: '20 MSps', health: 'ok' },
	{ id: 'kismet', name: 'Kismet', state: 'LIVE', since: '0:35', band: '2.4 / 5 GHz', rate: '214 dev', health: 'ok' },
	{ id: 'gsm-evil', name: 'GSM-Evil', state: 'LIVE', since: '0:34', band: '900 / 1800', rate: '8 imsi/m', health: 'ok' },
	{ id: 'tak', name: 'TAK Broadcast', state: 'LIVE', since: '0:33', band: 'CoT 8087', rate: '14 msg', health: 'ok' },
	{ id: 'ubertooth', name: 'Ubertooth', state: 'IDLE', since: '—', band: 'BLE 2.4 GHz', rate: '—', health: 'idle' },
	{ id: 'gnss', name: 'GNSS-RTK', state: 'DEG', since: '0:31', band: 'L1 / L2', rate: '1 Hz', health: 'warn' }
];
