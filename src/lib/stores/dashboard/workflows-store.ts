...
const MOCK_WORKFLOWS: Workflow[] = [
	{ cat: 'RECON', name: 'recon-full', desc: 'survey · harvest · triage', steps: 7, last: 'ran 12m ago' },
	{ cat: 'RECON', name: 'wifi-survey', desc: 'kismet + wigle + tak push', steps: 4, last: 'ran 4h ago' },
	{ cat: 'RECON', name: 'bt-sweep', desc: 'bluetoothctl · btlejack', steps: 3, last: 'ran 2d ago' },
	{ cat: 'GSM/SDR', name: 'imsi-harvest', desc: 'grgsm → pipe → csv', steps: 3, last: 'running now', hot: true },
	{ cat: 'GSM/SDR', name: 'p25-trunk', desc: 'trunk-recorder · p25', steps: 4, last: 'ran 1h ago' },
	{ cat: 'BLUE-TEAM', name: 'blue-team-check', desc: 'self-scan + alert', steps: 5, last: 'yesterday' },
	{ cat: 'BLUE-TEAM', name: 'integrity-audit', desc: 'rkhunter + chkrootkit', steps: 6, last: 'ran 3d ago' },
	{ cat: 'POST-OPS', name: 'triage-report', desc: 'claude · markdown + tak', steps: 4, last: 'ran 28m ago' },
	{ cat: 'POST-OPS', name: 'artifact-rotate', desc: 'pcap → cold storage', steps: 2, last: 'ran 4h ago' },
	{ cat: 'CUSTOM', name: 'custom-playbook', desc: 'user-defined', steps: 0, last: 'never' },
	{ cat: 'CUSTOM', name: 'kaserne-night', desc: 'op-specific · 2025-04', steps: 9, last: 'ran yesterday' },
